	...
	{  extend: 'uxExtSpect.view.object.datalist.PropertiesOrArrayList',
		...
		objectToPropertyRecs: function ( object ) {
			...
			if ( parentTabPanel.isCollectionTabPanel || parentTabPanel.isMixedCollectionTabPanel ) {
				...
				if ( ! ( object instanceof Ext.util.Collection ) && ! ( object instanceof Ext.util.MixedCollection ) ) { console.warn( 'object is not a collection in PropertiesList.objectToPropertyRecs' ); }
			}

			for ( var property in object ) {
				if ( showOnlyOwnProps && ! object.hasOwnProperty( property ) ) { continue; }
