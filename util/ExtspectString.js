...
Ext.define( 'ux.extspect.util.ExtspectString', { } );

if ( !ux.extspect.util.StringOf ) { ux.extspect.util.StringOf = {} }

Ext.extspectString = function () { return ux.extspect.util.StringOf.embrace$( '', 'Ext' ); };
Ext.extspectString._name = 'Ext#extspectString';

// moved to ux.extspect.util.StringOf.js
...
Ext.app.Application.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "App", ux.extspect.util.StringOf.quote$( this.name ) ); };
Ext.app.Application.prototype.extspectString._name = 'Ext.app.Application#extspectString';
// ux.extspect.util.StringOf.object$( ExtSpectSolo.app )

Ext.Loader.require( 'Ext.util.Collection',
	function () {
		Ext.util.Collection.prototype.extspectString =
			function () {
				return ux.extspect.util.StringOf.class$( this ) ||
					ux.extspect.util.StringOf.embrace$( "Clctn", ux.extspect.util.StringOf.to$( this.items ) +
...
Ext.Loader.require( 'Ext.util.HashMap',
	function () {
		Ext.util.HashMap.prototype.extspectString =
			function () { return ux.extspect.util.StringOf.embrace$( "HashMap", ux.extspect.util.StringOf.to$( this.getValues() ) ); };
...
Ext.util.MixedCollection.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "MxdClctn", ux.extspect.util.StringOf.to$( this.items ) ); };
...
Ext.ItemCollection.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "ItmClctn", ux.extspect.util.StringOf.to$( this.items ) ); };
...
Ext.app.Controller.prototype.extspectString =
	function () {
		return  ux.extspect.util.StringOf.class$( this ) ||
			ux.extspect.util.StringOf.embrace$( "Cntrlr", ux.extspect.util.StringOf.quote$( ux.extspect.util.StringOf.lastPartOfName( this.$className, 1 ) ) );
	};
...
/*Ext.Loader.require( 'Ext.data.Model' )
 ...
 function ( ) { return ux.extspect.util.StringOf.embrace$( "Model" , ux.extspect.util.StringOf.to$( "????"))}///this.getName() ) ) }
...
Ext.Loader.require( 'Ext.data.Store',
	function () {
		Ext.data.Store.prototype.extspectString =
			function () { return ux.extspect.util.StringOf.embrace$( "Store", ux.extspect.util.StringOf.quote$( this.getStoreId() ) ); };
...
Ext.Loader.require( 'Ext.data.proxy.Proxy',
	function () {
		Ext.data.proxy.Proxy.prototype.extspectString =
			function () { return ux.extspect.util.StringOf.embrace$( "Proxy", ux.extspect.util.StringOf.quote$( this.id ) ); };
...
Ext.app.Route.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "Route", this.getUrl() + ':' + this.getAction() ); };
...
Ext.Loader.require( 'Ext.data.Field',
	function () {
		Ext.data.Field.prototype.extspectString =
			function () { return ux.extspect.util.StringOf.embrace$( "Field", ux.extspect.util.StringOf.quote$( this.getName() ) ); };
		Ext.data.Field.prototype.extspectString._name = 'Ext.data.Field#extspectString';
	}
);

Ext.dom.Element.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "ExtElmnt", ux.extspect.util.StringOf.quote$( this.id ) ); };
Ext.dom.Element.prototype.extspectString._name = 'Ext.dom.Element#extspectString';

// ========== JAVASCRIPT OBJECTS

Array.prototype.extspectString = function () { return ux.extspect.util.StringOf.array$( this ); }; // typeof( [] ) -> 'object'
Array.prototype.extspectString._name = 'Array#extspectString';

// typeof( new Boolean( false ) ) -> 'object'
Boolean.prototype.extspectString = function () { return ux.extspect.util.StringOf.embrace$( 'Bln', this ); };
Boolean.prototype.extspectString._name = 'Boolean#extspectString';
// console.log( new Boolean( false ).to$() )

Date.prototype.extspectString = function () { return ux.extspect.util.StringOf.date$( this ); };
Date.prototype.extspectString._name = 'Date#extspectString';

// typeof( ux.extspect.util.StringOf.to$ ) -> 'function'
Function.prototype.extspectString = function () {
	if ( "modelName" in this ) { return ux.extspect.util.StringOf.embrace$( 'Model', ux.extspect.util.StringOf.quote$( ux.extspect.util.StringOf.functionName( this ) ) ); }
	return ux.extspect.util.StringOf.functionName( this ) + '()';
};
Function.prototype.extspectString._name = 'Function#extspectString';
// console.log( ux.extspect.util.StringOf.to$.to$() )

// typeof( new Number( '234' ) ) -> 'object'
Number.prototype.extspectString = function () { return ux.extspect.util.StringOf.embrace$( 'Number', this ); };
Number.prototype.extspectString._name = 'Number#extspectString';
// console.log( new Number( '234' ).to$() )

RegExp.prototype.extspectString = function () { return ux.extspect.util.StringOf.ellipsis$( ux.extspect.util.StringOf.embrace$( 'RegExp', this ) ); };
RegExp.prototype.extspectString._name = 'RegExp#extspectString';

// typeof( new String( 'ABC' ) ) -> 'object'
String.prototype.extspectString = function () { return ux.extspect.util.StringOf.embrace$( 'String', ux.extspect.util.StringOf.quote$( this ) ); };
...
DOMTokenList.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "DomTknList", ux.extspect.util.StringOf.object$( this ) ); };
DOMTokenList.prototype.extspectString._name = 'DOMTokenList#extspectString';

HTMLCollection.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "HtmlClctn", ux.extspect.util.StringOf.object$( this ) ); };
...
KeyboardEvent.prototype.extspectString = function () {
	var dataString = '';
	if ( "keyCode" in this ) { dataString = ux.extspect.util.StringOf.keyCode$( this.keyCode ) + ', ' + this.charCode; }
	return ux.extspect.util.StringOf.embrace$( "KybrdEvent", dataString || ux.extspect.util.StringOf.object$( this ) );
};
...
MouseEvent.prototype.extspectString = function () {
	...
	return ux.extspect.util.StringOf.embrace$( "MsEvnt", dataString || ux.extspect.util.StringOf.object$( this ) );
};
MouseEvent.prototype.extspectString._name = 'MouseEvent#extspectString';

NamedNodeMap.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "NmdNodeMap", ux.extspect.util.StringOf.object$( this ) ); };
NamedNodeMap.prototype.extspectString._name = 'NamedNodeMap#extspectString';

//Node.prototype.extspectString =
//	function ( ) { return ux.extspect.util.StringOf.embrace$( "Node" , ux.extspect.util.StringOf.object$( this ) ) }
//Node.prototype.extspectString._name = 'Node#extspectString'

NodeList.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "NodeList", ux.extspect.util.StringOf.object$( this ) ); };
NodeList.prototype.extspectString._name = 'NodeList#extspectString';
/*
 HTMLScriptElement.prototype.extspectString =
 function ( ) { return ux.extspect.util.StringOf.embrace$( "SCRIPT" , this.src ) }
 HTMLScriptElement.prototype.extspectString._name = 'HTMLScriptElement#extspectString'*/

Text.prototype.extspectString =
	function () { return ux.extspect.util.StringOf.embrace$( "Text", ux.extspect.util.StringOf.object$( this ) );};
